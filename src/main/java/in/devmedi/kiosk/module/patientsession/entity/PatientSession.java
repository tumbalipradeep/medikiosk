...
/**
 * Represents an authenticated patient's active case-taking session.
 */
@Entity
...
public class PatientSession {
    ...
    protected PatientSession() {
    }

    public PatientSession(User user) {
        this.user = user;
        this.status = PatientSessionStatus.ACTIVE;
